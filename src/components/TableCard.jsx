  ...
  return (
    <div className="bg-white rounded-lg p-6 flex flex-col h-full shadow-sm hover:shadow-md transition">
      ...
      <div className="flex items-center justify-between mb-6">
        <h3 className="font-bold text-lg text-black">TABLE : {table.table_number}</h3>
        <div className="flex items-center gap-2">
          ...
          >
            <span
              className={`inline-block h-4 w-4 transform rounded-full bg-white transition ${table.status === "VACANT"
                ? "translate-x-6"
                : "translate-x-1"
                }`}
            />
